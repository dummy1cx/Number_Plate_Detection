...
def decode_yolo_output(output, anchors, stride, conf_thresh=0.5, iou_thresh=0.05):
   ...
   ## Few of the codes are refernced from Github repos and pytorch docs
   ##--------------------------------------------------------------------
    ...
    for b in range(B):
        ...
        # This reduces and filter boxes by objectness threshold
        ...
        # Flatten all predicted co-ordinates
